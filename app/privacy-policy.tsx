    ...
    <ScrollView>
      <SafeAreaView>
        <VStack className="gap-2 p-5">
          ...
          <Text className="text-xl font-bold">Table of content</Text>

          <Text>What data do we collect?</Text>
          <Text>How do we collect your data?</Text>
          <Text>How will we use your data?</Text>
          <Text>How do we store your data?</Text>
          <Text>
            Newsletter and communication What are your data protection rights?
          </Text>
          <Text> What are cookies?</Text>
          <Text>How do we use cookies? How to manage your cookies?</Text>
          <Text>
            Privacy policies of other websites Changes to our privacy policy How
            to contact us?
          </Text>
          <Text>How to contact the appropriate authorities</Text>

          <Text className="text-xl font-bold">What data do we collect?</Text>
          ...
          <Text>
            ...
            <Text>input from surveys and customer panel.</Text>
          </Text>

          <Text className="text-lg font-bold">GoatCounter</Text>
          <Text>
          ...
          <Text>The following attributes are collected by GoatCounter:</Text>

          <Text>Page URL (and parameters)</Text>
          <Text>Referer header</Text>
          <Text>User-Agent header</Text>
          <Text>Screen size</Text>
          <Text>Country name based on IP address</Text>
          <Text>A hash of the IP address, User-Agent, and random number</Text>
          ...
          <Text>
            ...
            <Text>use or view our website via your browser's cookies.</Text>
            The Clothing Loop may also receive your data indirectly from the
            following sources:
            <Text>None.</Text>
          </Text>

          <Text className="text-xl font-bold">How will we use your data?</Text>

          <Text>
            The Clothing Loop collects your data so that we can:
            <Text>process your registration with the Clothing Loop;</Text>
            <Text>
            ...
            <Text>if new people are added to the route this may change;</Text>
            <Text>
            ...
            <Text>contact you if necessary;</Text>
            <Text>improve processes and maximize impact;</Text>
            <Text>process your order;</Text>
          ...
          <Text className="text-xl font-bold">How do we store your data?</Text>
          ...
          <Text>
            ...
            <Text>
              ...
              our email:{" "}
              <Link href="mailto:hello@clothingloop.org">
          ...
          <Text className="text-xl font-bold">What are cookies?</Text>
          ...
          <Text className="text-xl font-bold">How do we use cookies?</Text>

          <Text>The Clothing Loop uses cookies for:</Text>
          <Text>
          ...
          <Text className="text-xl font-bold">How to manage cookies</Text>
          ...
          <Text className="text-xl font-bold">How to contact us</Text>
          ...
          <Text className="text-xl font-bold">Contact details</Text>

          <Text>Do you have any questions? Then contact us at:</Text>
          <Text>
            Email:{" "}
            <Link href="mailto:hello@clothingloop.org">
              hello@clothingloop.org
          ...
          <Text>Or by post:</Text>

          <Text>The Clothing Loop</Text>
          <Text>P/A Stichting Slow Fashion Movement</Text>
          <Text>Wethouder Frankeweg 22 H</Text>
          <Text>1098 LA Amsterdam</Text>
